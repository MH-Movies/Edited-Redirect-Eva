...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+0tLsWu80_CEwNzk1')
                        ]
                    ]
                )
            )
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('Aʟʟ Mᴏᴠɪᴇs Hᴜʙ 🎭', url='https://t.me/All_MH_Movies'),
        InlineKeyboardButton('OTT RELEASES 📢', url='https://t.me/MovieHub_OTT'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
...
async def auto_filter(client, msg: pyrogram.types.Message, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            fmsg = await message.reply_photo(photo="https://telegra.ph/file/43b6c56689714d37af314.jpg",
                                      reply_markup=InlineKeyboardMarkup(btn))
